const htmlList = [
  { id: 1, sort: 1, type: 'html', question: '块级元素、非块级元素(内联)和空元素', answer: '块：header、nav、footer、aside、section、div、article、p(ul、ol)\n\n内联：span、a\n\n空：hr、br(不能加样式)\n\nli(display: list-item)'},
  { id: 2, sort: 2, type: 'html', question: '语义化和h5标签', answer: '方便被pc浏览器识别内容、\n方便交接、\n方便重构、'},
  ...
  { id: 5, sort: 5, type: 'html', question: '浏览器工作原理', answer: '浏览器工作的流程大体就是这样：\nDNS查找，\nTCP(TLS)握手，\n发送http请求，\n构建DOM，\n构建CSS，\nCSS构建DOM，\n布局，\n绘制等', details: '浏览器在解析html的时候是一个单线程，在扫描代码过程中，如果遇到script标签，浏览器会加载script文件，并执行其代码，此时html暂停解析,所以才把脚本放html后面；像css和图片是异步的可以先加载，html会先渲染后样式回来会回流重绘'},
  { id: 6, sort: 6, type: 'html', question: 'donctype的作用和模式区别', answer: '浏览器的解析器使用哪种HTML规范\n\n严格模式：又称标准模式，是指浏览器按照W3C标准来解析代码，呈现页面\n混杂模式：又称为怪异模式或者兼容模式，是指浏览器按照自己的方式来解析代码，使用一种比较宽松的向后兼容的方式来显示页面  '},
  { id: 7, sort: 7, type: 'html', question: '倒三角', answer: 'width/height:0;\nboder:6px solid transparent;\nboder-top:6px solid #f00;\n(所有边先隐藏，在设置展示的边顺序不能变)',details: 'display: block;\nwidth: 0;\nheight: 0;\nborder: 10px solid transparent;\nborder-top: 10px solid #f00;'},
  ...
  { id: 13, sort: 13, type: 'html', question: '前端页面有哪三层构成，分别是什么？作用是什么？', answer: '结构层、\n表示层、\n行为层', details: '结构层：由 HTML 或 XHTML 之类的标记语言负责创建。标签，也就是那些出现在尖括号里的单词，对网页内容的语义含义做出了描述，但这些标签不包含任何关于如何显示有关内容的信息。例如，P 标签表达了这样一种语义：“这是一个文本段。”\n表示层：由 CSS 负责创建。 CSS 对“如何显示有关内容”的问题做出了回答\n行为层：负责回答“内容应该如何对事件做出反应”这一问题。这是 Javascript 语言和 DOM 主宰的领域。'},
  { id: 14, sort: 14, type: 'html', question: 'DOM事件的执行顺序', answer: 'onBlur\n > onChange\n > onClick\n > onFocus\n > onKeyDown'},
