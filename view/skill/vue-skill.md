...
子组件和父组件的生命周期顺序？ [先子后父](https://blog.csdn.net/FFFKKC/article/details/123715977)
...
一个原生的JS对象去描述一个DOM节点（将HTML结构层映射成行为层JS的树型结构对象)
虚拟dom比真实dom体积小，操作是相对来说消耗性能少，虚拟Dom不会进行回流和重绘操作
真实Dom频繁的回流和重绘效率非常低



掌握常用前端库的使用(如vue、react) ，能够掌握基本原理并使用其进行前端应用开发。
